...
## النشر على Netlify (للوصول من خارج المركز)

اربط المستودع بموقع على Netlify — ملف `netlify.toml` يضبط أمر البناء ومجلد النشر تلقائيًا. عندها يستخدم النظام **Netlify Blobs** كقاعدة بيانات مشتركة بدل الملف المحلي، بنفس نظام الدخول والصلاحيات، ويصبح البرنامج متاحًا من أي مكان عبر HTTPS.
